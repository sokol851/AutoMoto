...
class Milage(models.Model):
    car = models.ForeignKey(Car, on_delete=models.CASCADE, **NULLABLE, verbose_name='Машина')
    moto = models.ForeignKey(Moto, on_delete=models.CASCADE, **NULLABLE, verbose_name='Мотоцикл')
